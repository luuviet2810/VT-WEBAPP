...
import { Facebook, MessageCircle, MessageSquare, Phone, X } from 'lucide-react'
import { SITE_CONFIG } from '../contactConfig'

/**
 * Nút bong bóng liên hệ cố định góc dưới phải.
 * Đóng: chỉ 1 nút tròn 💬. Mở: 4 lựa chọn rõ ràng (Messenger, Phone,
 * Facebook, KakaoTalk) với animation nhẹ — không chiếm màn hình.
 */
const CHANNELS = [
