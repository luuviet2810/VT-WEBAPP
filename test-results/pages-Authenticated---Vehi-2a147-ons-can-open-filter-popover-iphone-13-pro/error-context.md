...
- main:
  ...
  - link "0302 Đang sửa Canival 7.300.000 đ Nhiệm vụ Đầu vào Đầu ra":
    ...
    - button "Đầu ra":
      - img
  - link "0546 Đầu vào Cruze 3.800.000 đ Nhiệm vụ Đầu vào Đầu ra":
    - /url: /xe/aa80790d-b510-4fc9-aedc-bb398f24d9b2
    - img
    - text: 0546 Đầu vào Cruze 3.800.000 đ
    - button "Nhiệm vụ":
      - img
    - button "Đầu vào":
      - img
  ...
  - link "9028 Mới nhập Malibu 3.800.000 đ Nhiệm vụ Đầu vào Đầu ra":
    ...
    - button "Đầu ra":
      - img
  - link "9125 Đầu vào SM5 2.200.000 đ Nhiệm vụ Đầu vào Đầu ra":
    - /url: /xe/9d5e3785-a6ba-43f6-8184-7276a02c22b5
    - img
    - text: 9125 Đầu vào SM5 2.200.000 đ
    - button "Nhiệm vụ":
      - img
    - button "Đầu vào":
      - img
